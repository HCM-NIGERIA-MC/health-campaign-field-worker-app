...
@RoutePage()
class CustomInventoryFacilitySelectionSMCPage extends LocalizedStatefulWidget {
  final List<FacilityModel> facilities;

  const CustomInventoryFacilitySelectionSMCPage({
    super.key,
  ...
  @override
  State<CustomInventoryFacilitySelectionSMCPage> createState() =>
      CustomInventoryFacilitySelectionSMCPageState();
}

class CustomInventoryFacilitySelectionSMCPageState
    extends LocalizedState<CustomInventoryFacilitySelectionSMCPage> {
