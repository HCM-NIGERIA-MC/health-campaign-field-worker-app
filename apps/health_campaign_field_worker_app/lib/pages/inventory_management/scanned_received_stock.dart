...
// @RoutePage()
// class ScannedReceivedStockPage extends LocalizedStatefulWidget {
//   final String mrnNumber;
//   final List<StockModel> stockRecords;

//   const ScannedReceivedStockPage({
//     super.key,
...
//   @override
//   State<ScannedReceivedStockPage> createState() =>
//       _ViewStockRecordsCDDPageState();
// }

// class _ViewStockRecordsCDDPageState
//     extends LocalizedState<ScannedReceivedStockPage>
...
//             currentForm.control(_quantityReceivedKey).value;
//         final stockQuantity =
...
//                               .translate(getMaterialNoteNumberLabel(stock)))),
