              ...
              builder: (context, stockState) {
                ...
                switch (entryType) {
                  case StockRecordEntryType.receipt:
                    ...
                    quantityUnitLabel =
                        i18_local.stockDetails.quantityReceivedUnitLabel;
                  ...
                  case StockRecordEntryType.dispatch:
                    ...
                    quantityUnitLabel =
                        i18_local.stockDetails.quantitySentUnitLabel;
                  ...
                  case StockRecordEntryType.returned:
                    ...
                    quantityUnitLabel =
                        i18_local.stockDetails.quantityReturnedUnitLabel;
                    transactionType = TransactionType.received.toValue();
                    break;
                  case StockRecordEntryType.loss:
                    ...
                    quantityUnitLabel =
                        i18_local.stockDetails.quantityLostUnitLabel;
                  ...
                  case StockRecordEntryType.damaged:
                    ...
                    quantityUnitLabel =
                        i18_local.stockDetails.quantityDamagedUnitLabel;
                                            ...
                                            final stockModel = StockModel(
                                              ...
                                              auditDetails: AuditDetails(
                                                createdBy: InventorySingleton()
                                                    .loggedInUserUuid,
                                                createdTime: stockState
                                                            .dateOfRecord ==
                                                        null
                                                    ? context
                                                        .millisecondsSinceEpoch()
                                                    : stockState.dateOfRecord!
                                                        .millisecondsSinceEpoch,
                                              ),
                                              clientAuditDetails:
                                                  ClientAuditDetails(
                          ...
                          DigitCard(
                            ...
                            children: [
                              ...
                              ReactiveWrapperField(
                                ...
                                validationMessages: {
                                  'required': (object) =>
                                      '${module.commentsLabel}_IS_REQUIRED',
                                },
                                showErrors: (control) =>
                                    control.invalid && control.touched,
                                builder: (field) {
                                  return LabeledField(
                                    ...
                                    child: DigitDropdown(
                                      ...
                                      onSelect: (value) {
                                        /// Find the selected product variant model by matching the id
                                        final selectedVariant =
                                            commentsOptions.firstWhere(
                                          (comment) => comment == value.code,
                                        );
