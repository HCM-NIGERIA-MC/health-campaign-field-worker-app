    ...
    return InventorySingleton().projectId.isEmpty
        ...
        : BlocConsumer<FacilityBloc, FacilityState>(
            ...
            builder: (ctx, facilityState) {
              ...
              final currentFacility = facilities.firstWhereOrNull(
                (facility) =>
                    facility.address?.boundary ==
                    InventorySingleton().boundary?.code,
              );

              // controller1.text = currentFacility != null
              //     ? localizations.translate('FAC_${currentFacility.id}')
              //     : '';
                              ...
                              DigitCard(
                                  ...
                                  children: [
                                    ...
                                    DigitDateFormPicker(
                                      ...
                                      start: DateTime(
                                          now.year - 150, now.month, now.day),
                                    ...
                                    ReactiveFormConsumer(
                                      builder: (context, form, child) {
                                        final datePickerControl =
                                            form.control(_dateOfEntryKey);
