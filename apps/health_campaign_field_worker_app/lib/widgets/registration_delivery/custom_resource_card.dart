...
class CustomResourceCard extends LocalizedStatefulWidget {
...
class _CustomResourceCardState extends LocalizedState<CustomResourceCard> {
  ...
  getProductVariants(RegistrationWrapperState state) {
    return customFetchProductVariant(
